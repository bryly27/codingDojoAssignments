...
class Login extends CI_Controller {
	...
	public function register()
	{
	    ...
	    if ($this->form_validation->run() == FALSE)
			{
				echo 'Please make sure you filled out all of the information correctly!<br>';
				echo 'First and last names needs to be at least 2 characters<br>';
				echo 'Email address needs to be valid<br>';
				echo 'Passwords need to match and be at least 8 characters<br>';
				// $this->load->view('landing');
			}
			else
			{
